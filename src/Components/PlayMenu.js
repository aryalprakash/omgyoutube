...
export class PlayMenu extends Component {
    ...
    render(){
        ...
        {type === 'movie-torrents' ? <Link to="/movie-torrents"><div className="playlist-button active">Torrents</div></Link> : <Link to="/movie-torrents" ><div className="playlist-button ">Torrents</div></Link>}
