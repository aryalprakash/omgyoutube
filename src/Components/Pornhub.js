...
class Pornhub extends Component {
    ...
    render() {
        ...
        let Iframe="iframe";
        let pornhubId = this.props.routeParams.videoID;
                ...
                <div className="left" ref="left">
                    <div className="video">
                        <div className="video-container" ref="videoFrame">
                            <iframe className="video" src={'https://www.pornhub.com/embed/' + pornhubId} frameborder="0" scrolling="no" allowFullScreen></iframe>
                        </div>
                    </div>
...
export default connect(mapStateToProps)( Pornhub )